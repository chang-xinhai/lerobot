...
"""Pre-processor and post-processor pipelines for DP3 policy."""
...
def make_dp3_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for DP3 policy.
    ...
    Args:
        config: The configuration object for the DP3 policy.
